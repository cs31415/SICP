...
(exp z1 z2)
; This goes into an infinite loop owing to the recursive call to 
; apply-generic with the same set of arguments.


; b.

; Louis is correct that coercing to the same type is problematic.

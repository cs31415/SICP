...
(define m (make-mobile (make-branch 10 20) (make-branch 15 30)))
(define m (make-mobile (make-branch 10 (make-mobile (make-branch 10 20) (make-branch 20 40))) (make-branch 15 30)))
...
(torque (make-branch 10 (make-mobile (make-branch 10 5) (make-branch 10 20))))
;250
...
(define n (make-mobile 
           (make-branch 10 (make-mobile (make-branch 10 20) (make-branch 10 20))) 
           (make-branch 10 40)))
